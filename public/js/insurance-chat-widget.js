(function () {
  ...
  var CSS =
    "#ar-chat-launcher{position:fixed;right:20px;bottom:calc(20px + var(--ar-bottom-inset, 0px));z-index:9998;background:#1A200C;color:#fff;border:none;" +
    ...
    "#ar-chat-launcher:hover{background:#3A4720;}" +
    ...
    "#ar-chat-header{background:#1A200C;color:#fff;padding:14px 16px;display:flex;justify-content:space-between;align-items:center;}" +
    ...
    ".ar-msg-user{align-self:flex-end;background:#1A200C;color:#fff;}" +
    ".ar-msg-note{align-self:center;background:#eef1ec;color:#1A200C;font-size:12px;text-align:center;border-radius:10px;}" +
    ".ar-msg-note a{color:#1A200C;font-weight:700;}" +
    ...
    "#ar-chat-input:focus{outline:none;border-color:#1A200C;}" +
    "#ar-chat-send{background:#1A200C;color:#fff;border:none;border-radius:20px;padding:0 18px;font-size:13.5px;font-weight:600;cursor:pointer;}" +
