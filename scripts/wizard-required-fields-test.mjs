...
const PAGES = [
  ...
  // converted together. Home (Habitação) is the first of the four ramos.
  {
    ...
    scripts: [
      'lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js',
      'quote-nationality.js', 'quote-field-toggle.js', 'quote-wizard.js',
    ],
    activateIds: ['pl-hab-obras-check'],
    values: {
      nome: 'Jan Kowalski',
      nif: '501442600',
      data_nascimento: '1985-03-15',
      ...
      localidade: 'Lagos',
      codigo_postal: '8600-100',
      telefone: '+48 601 234 567',
      email: 'teste@example.com',
      nacionalidade_nome: 'Polska',
      residente_fiscal: 'sim',
      regime_ocupacao: 'alojamento_local',
      al_regime: 'tempo_inteiro',
      ano_construcao: '1998',
      ...
      casas_banho: '2',
      obras_ano: '2020',
      obras_descricao: 'Nowy dach i wymienione okna.',
      capital_edificio: '250000',
      capital_conteudo: '40000',
      data_inicio: '2026-10-01',
      rgpd: true,
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/se/hemforsakring-portugal/',
    formName: 'se-hemforsakring-wizard',
    scripts: [
      'lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js',
      'quote-nationality.js', 'quote-field-toggle.js', 'quote-wizard.js',
    ],
    activateIds: ['se-hab-obras-check'],
    values: {
      nome: 'Erik Andersson',
      nif: '501442600',
      data_nascimento: '1985-03-15',
      ...
      localidade: 'Lagos',
      codigo_postal: '8600-100',
      telefone: '+46 70 123 45 67',
      email: 'teste@example.com',
      nacionalidade_nome: 'Sverige',
      residente_fiscal: 'sim',
      regime_ocupacao: 'alojamento_local',
      al_regime: 'tempo_inteiro',
      ano_construcao: '1998',
      ...
      casas_banho: '2',
      obras_ano: '2020',
      obras_descricao: 'Nytt tak och nya fönster.',
      capital_edificio: '250000',
      capital_conteudo: '40000',
      data_inicio: '2026-10-01',
      rgpd: true,
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/dk/husforsikring-portugal/',
    formName: 'dk-husforsikring-wizard',
    scripts: [
      'lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js',
      'quote-nationality.js', 'quote-field-toggle.js', 'quote-wizard.js',
    ],
    activateIds: ['dk-hab-obras-check'],
    values: {
      nome: 'Anders Nielsen',
      nif: '501442600',
      data_nascimento: '1985-03-15',
      ...
      localidade: 'Lagos',
      codigo_postal: '8600-100',
      telefone: '+45 20 12 34 56',
      email: 'teste@example.com',
      nacionalidade_nome: 'Danmark',
      residente_fiscal: 'sim',
      regime_ocupacao: 'alojamento_local',
      al_regime: 'tempo_inteiro',
      ano_construcao: '1998',
      ...
      casas_banho: '2',
      obras_ano: '2020',
      obras_descricao: 'Nyt tag og nye vinduer.',
      capital_edificio: '250000',
      capital_conteudo: '40000',
      data_inicio: '2026-10-01',
      rgpd: true,
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/zh/home-insurance-portugal/',
    formName: 'zh-home-insurance-wizard',
    scripts: [
      'lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js',
      'quote-nationality.js', 'quote-field-toggle.js', 'quote-wizard.js',
    ],
    activateIds: ['zh-hab-obras-check'],
    values: {
      nome: 'Li Wei',
      nif: '501442600',
      data_nascimento: '1985-03-15',
      ...
      localidade: 'Lagos',
      codigo_postal: '8600-100',
      telefone: '+86 138 0013 8000',
      email: 'teste@example.com',
      nacionalidade_nome: '中国',
      residente_fiscal: 'sim',
      regime_ocupacao: 'alojamento_local',
      al_regime: 'tempo_inteiro',
      ano_construcao: '1998',
  ...
  // Especificação v2, Parte C — Hebrew, first ramo.
  {
    label: 'IL /il/home-insurance-portugal/',
    path: 'il/home-insurance-portugal/index.html',
    url: 'https://adlerrochefort.com/il/home-insurance-portugal/',
    formName: 'il-home-insurance-wizard',
    scripts: [
      'lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js',
      'quote-nationality.js', 'quote-field-toggle.js', 'quote-wizard.js',
    ],
    activateIds: ['il-hab-obras-check'],
    values: {
      nome: 'דוד כהן',
      nif: '501442600',
      data_nascimento: '1985-03-15',
      ...
      casas_banho: '2',
      obras_ano: '2020',
      obras_descricao: 'גג חדש וחלונות חדשים.',
      capital_edificio: '250000',
      capital_conteudo: '40000',
      data_inicio: '2026-10-01',
      rgpd: true,
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/se/sjukvardsforsakring-portugal/',
    formName: 'se-sjukvardsforsakring-wizard',
    expectPersonNameLabel: 'Fullständigt namn',
    scripts: ['lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js', 'quote-nationality.js', 'quote-wizard.js', 'quote-health-persons.js'],
    firstBatch: [
      'nome', 'nif', 'data_nascimento', 'morada', 'localidade',
      'codigo_postal', 'telefone', 'email', 'nacionalidade_nome', 'residente_fiscal',
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/dk/sundhedsforsikring-portugal/',
    formName: 'dk-sundhedsforsikring-wizard',
    expectPersonNameLabel: 'Fulde navn',
    scripts: ['lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js', 'quote-nationality.js', 'quote-wizard.js', 'quote-health-persons.js'],
    firstBatch: [
      'nome', 'nif', 'data_nascimento', 'morada', 'localidade',
      'codigo_postal', 'telefone', 'email', 'nacionalidade_nome', 'residente_fiscal',
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/zh/health-insurance-portugal/',
    formName: 'zh-health-insurance-wizard',
    expectPersonNameLabel: '全名',
    scripts: ['lead-branch-fields.js', 'quote-validators.js', 'ar-quote-form.js', 'quote-nationality.js', 'quote-wizard.js', 'quote-health-persons.js'],
    firstBatch: [
      'nome', 'nif', 'data_nascimento', 'morada', 'localidade',
      'codigo_postal', 'telefone', 'email', 'nacionalidade_nome', 'residente_fiscal',
  ...
  // converted together. Car (Auto) is the third of the four ramos.
  {
    ...
    url: 'https://adlerrochefort.com/pl/ubezpieczenie-samochodu-portugalia/',
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/dk/bilforsikring-portugal/',
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/zh/car-insurance-portugal/',
  ...
  // Especificação v2, Parte C — Hebrew, third ramo.
  {
    ...
    url: 'https://adlerrochefort.com/il/car-insurance-portugal/',
  ...
  // last of the four ramos.
  {
    ...
    url: 'https://adlerrochefort.com/pl/ubezpieczenie-odpowiedzialnosci-cywilnej-portugalia/',
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/se/ansvarsforsakring-portugal/',
  ...
  },
  {
    ...
    url: 'https://adlerrochefort.com/zh/liability-insurance-portugal/',
  ...
  {
    label: 'IL /il/liability-insurance-portugal/',
    path: 'il/liability-insurance-portugal/index.html',
    url: 'https://adlerrochefort.com/il/liability-insurance-portugal/',
