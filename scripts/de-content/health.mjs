...
<section class="section tint" aria-labelledby="international">
  <div class="container narrow article-body">
    ...
    <p>Eine portugiesische Police deckt Behandlung in Portugal, mit oder ohne begrenzter Notfalldeckung im Ausland. Eine internationale private Krankenversicherung (International Private Medical Insurance) deckt mehrere Länder, ist dafür aber in der Regel teurer und richtet sich eher an Vielreisende oder Familien mit Wohnsitz in mehreren Ländern. Für die meisten deutschen Residenten, die dauerhaft an der Algarve oder anderswo in Portugal leben, ist die portugiesische Lösung die passendere und wirtschaftlichere Wahl. [VERIFY: aktuelle internationale PMI-Anbieter im Portfolio, falls für Private-Clients-Fälle relevant]</p>
  </div>
</section>`,
