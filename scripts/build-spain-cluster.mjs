...
import { PAGES } from './spain-cluster.data.mjs';
...
// --- structured data ---------------------------------------------------------
// The provider is the real, verified regulatory identity: Ownizo/ASF/Lagos.
// No Spanish address, phone or registration number is invented — see the
// compliance note in spain-cluster.data.mjs.
