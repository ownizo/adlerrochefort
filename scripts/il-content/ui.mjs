...
export const IL_UI = {
  ...
  mega: {
    ...
    portugalMenu: 'תפריט פורטוגל',
    spain: 'ביטוח בספרד',
    spainMenu: 'תפריט ספרד',
    privateClients: 'Private Clients',
    privateClientsMenu: 'תפריט Private Clients',
    whyUs: 'למה אנחנו',
    whyUsMenu: 'תפריט למה אנחנו',
    overview: 'סקירה',
    personal: 'ביטוח אישי',
    personalShort: 'אישי',
    moving: 'מעבר ונכס',
    property: 'נכס',
    hubItem: 'ביטוח בפורטוגל',
    spainHub: 'ביטוח לתושבים זרים בספרד',
    spainHealth: 'ביטוח בריאות',
    spainHome: 'ביטוח דירה',
    spainCar: 'ביטוח רכב',
    spainLife: 'ביטוח חיים',
    spainLandlord: 'ביטוח למשכיר',
    spainMortgage: 'הגנת משכנתא',
    spainPC: 'ביטוח Private Client',
    pcPortugal: 'Private Clients — פורטוגל',
    pcSpain: 'Private Clients — ספרד',
    whyAbout: 'עלינו',
    whyHow: 'איך אנחנו עובדים',
    whyBroker: 'למה סוכן',
    whyClaims: 'תביעות',
    burger: 'תפריט',
  },
  ...
  f: {
    ...
    company: 'חברה (לא חובה)',
    companyPh: 'למשל: שם החברה, אם הפנייה קשורה לעסק',
