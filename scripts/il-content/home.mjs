...
export const HOME_PAGE = {
  ...
  cluster: 'home',
  title: 'ביטוח לבתים בעלי ערך גבוה בפורטוגל | Adler & Rochefort',
  description:
    'ביטוח לבתים בעלי ערך גבוה בפורטוגל ובספרד: סקר בנכס, בלי כלל ביטוח חסר, בנייה מחדש מובטחת, תכולה בכל הסיכונים, אמנות בערך מוסכם ואחריות משפחתית.',
  keywords:
    'ביטוח בית יוקרה בפורטוגל, ביטוח וילה בפורטוגל, ביטוח דירה בפורטוגל, ביטוח מבנה ותכולה, ביטוח אמנות ותכשיטים, ערך מוסכם, רעידת אדמה ביטוח פורטוגל',
  eyebrow: 'ביטוח בתים בעלי ערך גבוה',
  h1: 'ביטוח לבתים בעלי ערך גבוה בפורטוגל',
  standfirst:
...
<section class="section tint" aria-labelledby="misgeret-habayit">
  <div class="container">
    ...
    <p>מעל עלות בנייה מסוימת, השאלות משתנות. אלה תנאי הייחוס של הפוליסות ללקוחות פרטיים שאנחנו מסדרים בפרק המבנה, ואנחנו בודקים כל הצעה מולם, בכתב:</p>
    <div class="feature-grid">
      <div class="feature-card"><h3>סקר בנכס ועלות בנייה מחדש</h3><p>בבתים בעלי ערך גבוה המבטח עורך סקר בנכס, ללא עלות עבורכם, כדי לאשר את עלות הבנייה מחדש, להמליץ על סכומי הביטוח לתכולה ולפריטי הערך ולהציע אמצעים למניעת נזקים.</p></div>
      <div class="feature-card"><h3>בלי כלל ביטוח חסר</h3><p>כשמתקבלים הסכומים המומלצים, המבטח מוותר על כלל ביטוח החסר (<em dir="ltr">regra proporcional</em>): נזק חלקי משולם במלואו, גם אם עלויות הבנייה עלו בינתיים.</p></div>
      <div class="feature-card"><h3>בנייה מחדש מובטחת</h3><p>באובדן מוחלט הבית נבנה מחדש גם אם העלות עולה על סכום ביטוח המבנה — בתנאי שהסכומים שהומלצו בסקר התקבלו.</p></div>
      <div class="feature-card"><h3>דיור חלופי ברמה דומה</h3><p>דיור חלופי ברמה דומה, גם לחיות מחמד ולסוסים, כל עוד אי אפשר לגור בבית — ולא החודשים הספורים המקובלים בשוק הקמעונאי.</p></div>
      <div class="feature-card"><h3>גינה, חומות ומבני עזר</h3><p>עצים, שיחים ומדשאות, חומות גבול וקירות תמך, בריכות, מבני עזר ובתי אירוח — בסכומי ביטוח משלהם, ולא בתקרה סמלית.</p></div>
      <div class="feature-card"><h3>מים, גז ואיתור נזילות</h3><p>איתור ותיקון של דליפות מים, גז או סולר לחימום, ללא תת־גבול נפרד, כולל המים או הדלק שאבדו.</p></div>
      <div class="feature-card"><h3>תגמול לפי בחירתכם</h3><p>תשלום כספי, או תיקון על ידי הספקים, בעלי המלאכה והמשחזרים שתבחרו — בלי הפחתה על אף אחת מהאפשרויות.</p></div>
      <div class="feature-card"><h3>ויתור על השתתפות עצמית בנזק גדול</h3><p>מעל גובה נזק מסוים ההשתתפות העצמית אינה חלה כלל — בדיוק במקום שבו היא הייתה מכבידה יותר מכול.</p></div>
      <div class="feature-card"><h3>הבית של היום</h3><p>פאנלים סולריים, סוללות וגנרטורים לגיבוי, שדרוג סביבתי בבנייה מחדש, והחלפת מנעולים כשמפתחות אבדו או נגנבו.</p></div>
      <div class="feature-card"><h3>התאמת הבית לנכות</h3><p>עבודות התאמה בבית כשבן משפחה נותר עם נכות קבועה, בעקבות תאונה או מחלה.</p></div>
    </div>
  </div>
</section>

<section class="section plain" aria-labelledby="misgeret-tchula">
  <div class="container">
    <h2 id="misgeret-tchula">התכולה</h2>
    <p>רהיטים, חפצי בית וחפצים אישיים — בכיסוי כל הסיכונים, ולא ברשימה סגורה של אירועים:</p>
    <div class="feature-grid">
      <div class="feature-card"><h3>כל הסיכונים, בכל העולם</h3><p>חפצים אישיים מכוסים מפני כל הסיכונים — בבית, בנסיעות ובבית השני — ללא תת־גבול נפרד למה שאתם נושאים איתכם.</p></div>
      <div class="feature-card"><h3>תכולה מעבר לסכום הביטוח</h3><p>כשמתקבלים הסכומים המומלצים, התגמול יכול לעלות על סכום ביטוח התכולה בשיעור שהוסכם מראש, אם השווי האמיתי מתברר כגבוה יותר.</p></div>
      <div class="feature-card"><h3>בלי תת־גבולות במה שחשוב</h3><p>נזק ואובדן בתאונה, גניבה ממחסנים וממרתפים, וריהוט גן — בלי תת־גבולות שמרוקנים את הכיסוי מתוכן.</p></div>
      <div class="feature-card"><h3>חפצי אורחים ורכישות חדשות</h3><p>החפצים של האורחים שלכם מוגנים, ופריטים שרכשתם לאחרונה מכוסים אוטומטית במשך תקופת הצהרה.</p></div>
      <div class="feature-card"><h3>אירועים בבית</h3><p>ביטול אירועים ומבנים זמניים — אוהלים, במות — לאירועים שנערכים בבית.</p></div>
    </div>
  </div>
</section>

<section class="section tint" aria-labelledby="misgeret-erech">
  <div class="container">
    <h2 id="misgeret-erech">אמנות, אוספים ופריטי ערך</h2>
    <p>בפוליסת דירה רגילה פריטי ערך מוגבלים בסעיף נפרד, בדרך כלל כאחוז מסכום התכולה. בפוליסות ללקוחות פרטיים תכשיטים, שעונים, אמנות ואוספים נרשמים אחד־אחד, בערך מוסכם על סמך הערכת שמאי — ומה שנרשם הוא מה שמשולם:</p>
    <div class="feature-grid">
      <div class="feature-card"><h3>ערך מוסכם</h3><p>אמנות, תכשיטים, שעונים ואוספים נרשמים בערך שנקבע בתחילת החוזה על סמך הערכת שמאי — וזה הסכום שמשולם באובדן מוחלט, בלי ויכוח על פחת.</p></div>
      <div class="feature-card"><h3>ללא השתתפות עצמית</h3><p>על פריטי ערך המבוטחים בערך מוסכם או מוצהר לא חלה השתתפות עצמית.</p></div>
      <div class="feature-card"><h3>ירידת ערך אחרי שחזור</h3><p>כשפריט משוחזר אך מאבד מערכו בשוק, ההפרש משולם — ולתיקונים אין תקרת עלות.</p></div>
      <div class="feature-card"><h3>הגנה מפני הערכת חסר</h3><p>אם פריט עם הערכת שמאי מקצועית שווה ביום הנזק יותר מסכום הביטוח שלו, הפוליסה משלמת מעבר לערך המוסכם, בתוך שיעור מוגדר.</p></div>
      <div class="feature-card"><h3>רכישות חדשות ומרתפי יין</h3><p>פריטים חדשים מכוסים אוטומטית לתקופה מסוימת, ואוספי יין ומשקאות חריפים — עם תנאי אחסון משלהם.</p></div>
    </div>
    <p>השווי צריך להיות מתועד <em>לפני</em> האירוע ולא אחריו: הערכות שמאי, חשבוניות וצילומים שנשמרים מחוץ לבית. בתכשיטים ובשעונים שנרכשו בישראל שווה לשמור את החשבונית המקורית גם אם היא בעברית; אנחנו נסביר למבטח מה כתוב בה.</p>
  </div>
</section>

<section class="section plain" aria-labelledby="misgeret-achrayut">
  <div class="container">
    <h2 id="misgeret-achrayut">אחריות אזרחית משפחתית</h2>
    <p>גבול האחריות שמגיע עם פוליסת דירה רגילה נמוך לרוב ביחס למשק בית בעל הון משמעותי. בפוליסות ללקוחות פרטיים פרק האחריות בנוי כך:</p>
    <div class="feature-grid">
    ...
    <p><a href="/il/liability-insurance-portugal/">עוד על אחריות אזרחית משפחתית</a></p>
  </div>
</section>

<section class="section tint" aria-labelledby="misgeret-mishpacha">
  <div class="container">
    <h2 id="misgeret-mishpacha">הגנה על המשפחה</h2>
    <p>אותן פוליסות מתייחסות גם לסיכונים שאינם נזק לרכוש, ושמשפחות בעלות פרופיל גבוה חשופות אליהם יותר:</p>
    <div class="feature-grid">
      <div class="feature-card"><h3>חטיפה וסחיטה</h3><p>הוצאות חטיפה וכופר של בן משפחה, כולל יועצים מומחים ותגמול על מידע.</p></div>
      <div class="feature-card"><h3>חטיפת רכב ופריצה אלימה</h3><p>תמיכה ופיצוי לאחר חטיפת רכב, פריצה אלימה לבית, תקיפה, או אלימות בכביש או בטיסה.</p></div>
      <div class="feature-card"><h3>איומים והטרדה מאיימת</h3><p>יועצי אבטחה, מעבר זמני ותמיכה משפטית כשבן משפחה מאוים או מוטרד.</p></div>
      <div class="feature-card"><h3>בריונות ברשת ומוניטין</h3><p>פסיכולוג, יועץ אבטחת מידע, עורך דין, ובמידת הצורך עלות מעבר בית ספר לאחר בריונות חוזרת ברשת.</p></div>
      <div class="feature-card"><h3>ליווי נפשי</h3><p>ליווי מקצועי למשפחה לאחר כל אחד מהאירועים האלה.</p></div>
    </div>
    <p class="legal-note">אלה תנאי הייחוס של הפוליסות לבעלי הון גבוה שאנחנו מסדרים. הכיסויים, הגבולות, ההשתתפויות העצמיות והחריגים משתנים לפי המבטח ולפי הסיכון, ונקבעים רק במסמכי הפוליסה שמונפקת לכם.</p>
  </div>
</section>

<section class="section plain" aria-labelledby="mivne-vetchula">
  <div class="container narrow article-body">
    <h2 id="mivne-vetchula">היסודות: מבנה ותכולה, אותה חלוקה וגבול אחר</h2>
...
<section class="section plain" aria-labelledby="sechum-bituach">
  <div class="container narrow article-body">
    ...
    <p>ומה קורה אם הסכום נקבע נמוך מדי — מה שאתם מכירים כביטוח חסר. בפורטוגל הכלל נקרא <em dir="ltr">regra proporcional</em>, והוא חל גם על נזק חלקי. אם המבנה בוטח ב־60% בלבד מעלות הבנייה מחדש שלו, אז גם בנזק חלקי התגמול עלול להיחשב לפי אותם 60%, פחות ההשתתפות העצמית. אף אחד לא שרף את הבית; פשוט הסכום היה חסר. בפוליסות ללקוחות פרטיים זה בדיוק הסעיף שמשתנה: כשהסכומים שהומלצו בסקר מתקבלים, המבטח מוותר על הכלל הזה.</p>
    <p>לכן שווה להתייחס בכבוד לשדה הזה. שטח בנוי במטרים רבועים, שנת בנייה, סוג בנייה ואיכות הגימור הם הקלט; לא צריך שמאות פורמלית בשלב הפנייה, אבל כן צריך מספר מבוסס; בבתים בעלי ערך גבוה, הסקר של המבטח בנכס הוא שמאשר אותו. בתכולה ההיגיון זהה: סכום התכולה צריך לשקף מה יעלה לקנות הכול מחדש, לא מה שילמתם לפני שמונה שנים.</p>
...
<section class="section tint" aria-labelledby="ma-mechuse">
  <div class="container narrow article-body">
    <h2 id="ma-mechuse">בפוליסת דירה רגילה: מה בדרך כלל מכוסה, ואיפה מסתיים הכיסוי</h2>
    <p>ההיקף משתנה בין מבטחים ובין תוכניות, ולכן מה שלמטה הוא תמונה טיפוסית של השוק הקמעונאי ולא תיאור של פוליסה מסוימת — וזה גם הרקע שמסביר למה בתים בעלי ערך גבוה מבוטחים בנוסחים אחרים. בכל אחד מהסעיפים האלה החריגים הם מה שקובע.</p>
...
<section class="section tint" aria-labelledby="shimush-banechess">
  <div class="container narrow article-body">
    ...
    <p>ההיגיון פשוט: הצהרה מדויקת משנה לכל היותר את התנאים, והצהרה לא מדויקת עלולה לעלות את התביעה כולה. אם השימוש בנכס משתנה — עברתם לגור בו, התחלתם להשכיר, יצאתם לשנה — זה שינוי שצריך לדווח, לא פרט טכני.</p>
  </div>
</section>
...
<section class="section tint" aria-labelledby="checklist-israelim">
  <div class="container narrow article-body">
    ...
    <p>הצעה טובה עונה על עשר השאלות האלה בכתב. אם יש לכם כבר פוליסה, שלחו לנו אותה — נחזור אליכם בכתב עם התשובות לשאלות האלה, ועם מה שהיה משתנה בנוסח ללקוחות פרטיים.</p>
  </div>
</section>
...
<section class="section plain" aria-labelledby="mashkanta">
  ...
  faq: [
    {
      q: 'מה ההבדל בין פוליסה לבית בעל ערך גבוה לבין פוליסת דירה רגילה?',
      a: '<p>בעיקר במקומות שבהם פוליסה רגילה מגבילה את הכיסוי. בפוליסות ללקוחות פרטיים המבטח עורך סקר בנכס וממליץ על סכומי הביטוח; כשהסכומים מתקבלים, הוא מוותר על כלל ביטוח החסר (<em dir="ltr">regra proporcional</em>) ומבטיח בנייה מחדש גם מעבר לסכום המבנה. התכולה מכוסה מפני כל הסיכונים בכל העולם, אמנות ותכשיטים נרשמים בערך מוסכם ללא השתתפות עצמית, והאחריות האזרחית של המשפחה מגיעה לכמה מיליוני אירו. הכיסוי המדויק תלוי במבטח ובסיכון, ונקבע רק בפוליסה שמונפקת.</p>',
    },
    {
