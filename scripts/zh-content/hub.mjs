...
<section class="section tint" aria-labelledby="women-zenme-zuo">
  <div class="container narrow article-body">
    ...
    <ol class="process-steps">
      <li><strong>先谈情况。</strong>要保障什么、价值多少、谁住在里面、有没有房贷、是否有经营活动。</li>
      <li><strong>范围先于价格。</strong>先确定这份保单必须覆盖什么、哪些可以有意识地不买，然后再比较方案。</li>
      <li><strong>条款用英语书面说明。</strong>签字之前，保额、自负额、除外责任和报案时限会以书面形式说清楚。</li>
      <li><strong>理赔时有人对接。</strong>报案、与保险公司沟通、盯住时限。这部分才是一个中介真正的价值所在。</li>
    </ol>
