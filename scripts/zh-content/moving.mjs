...
export const MOVING_PAGE = {
  ...
  description:
    '迁居葡萄牙的保险时间表：出发前能办什么、NIF 之后才能办什么、医疗等待期为何要提前、搬运中的艺术品与贵重物品、落地后的房屋与车辆安排。',
  keywords:
  ...
  pullquote: '医疗保险的等待期，是唯一一件越早安排越从容、越晚安排越无解的事。',
  schemaType: 'Article',
...
<section class="section tint" aria-labelledby="women-de-zuoyong">
  <div class="container narrow article-body">
    ...
    <p>Adler &amp; Rochefort 在里斯本和拉各斯设有办公室，服务葡萄牙与西班牙的私人客户。迁居阶段最有用的服务不是出单，而是把顺序和时间点排清楚。我们可以在您还没到葡萄牙的时候就开始沟通：说明需要哪些资料、哪些事项必须等 NIF、哪些可以提前准备，以及在您的具体计划里哪几周可能出现保障空档。等到条件具备，再按顺序出单；如果您已有其他国家的保单，也可以先发给我们，我们会以书面形式说明哪些可以延续、哪些需要重新安排。</p>
