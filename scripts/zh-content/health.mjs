...
export const HEALTH_PAGE = {
  ...
  keywords:
    '国际医疗保险, 家庭国际医疗保险, 葡萄牙医疗保险, 葡萄牙私人医疗保险, 葡萄牙健康保险, SNS 葡萄牙, 葡萄牙家庭医疗保险, 葡萄牙儿童医疗保险, 葡萄牙医疗保险等待期',
  eyebrow: '国际私人医疗',
  h1: '家庭国际私人医疗保险：它解决什么，不解决什么',
  standfirst:
...
<section class="section plain" aria-labelledby="liang-ceng-jiegou">
  <div class="container narrow article-body">
    ...
    <div class="callout">
      ...
      如果您熟悉国内的百万医疗险——高额度、高免赔、事后报销——那么葡萄牙本地的私人医疗保险在结构上几乎是相反的：年度额度有限、按项目分项设限、每次就诊有共付金额，价值来自网络内的可及性。需要高额度与跨国保障的家庭，应当看的是国际医疗保单。
    </div>
    <h3>国际私人医疗保险</h3>
    <p>对于一年中在葡萄牙、西班牙和其他国家之间往来，或子女在海外求学的家庭，本地保单往往不够。国际私人医疗保险（<em>seguro de saúde internacional</em>）通常提供高得多的年度额度、可在全球或约定区域内自由选择医院与医生、直接结算，并可涵盖在其他国家就读的子女。保障区域（是否包含美国）、自负额与门诊模块是影响条件的主要因素，我们会按您家庭的实际居住与出行方式以书面形式建议。</p>
  </div>
</section>
...
<section class="section plain" aria-labelledby="biao-le-shenme">
  <div class="container narrow article-body">
    ...
    <p>把这七项逐一列出来，通常会发现看似相近的两份方案原本不是同一件东西。这也是我们以书面形式、逐项对照给出建议的原因。</p>
  </div>
</section>
...
<section class="section tint" aria-labelledby="women-de-zuoyong">
  <div class="container narrow article-body">
    ...
    <ul>
      <li><strong>投保前。</strong>确认您所在地区的网络覆盖、判断本地保单还是国际保单更适合您的家庭、按实际使用需求选择模块组合、说明等待期与核保流程、协助如实完成健康问卷，并在签字前用英语书面说明保额、共付、等待期与除外条款。</li>
