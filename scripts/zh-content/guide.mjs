...
export const GUIDE_PAGE = {
  ...
  description:
    '葡萄牙保险的完整入门：需要买哪些保险、哪些是强制的、外国人能否投保、保单由哪些文件组成、理赔怎么走、除了价格还该比较什么，以及保险中介的作用。',
  keywords:
    '葡萄牙保险, 葡萄牙保险指南, 葡萄牙保险常见问题, 外国人 葡萄牙保险, 葡萄牙保险理赔, 葡萄牙保险中介',
  eyebrow: '保险指南',
  h1: '葡萄牙保险指南：从头理解这个市场',
  standfirst:
    '这一页回答的是还没有细分到某个产品之前的问题：我到底需要哪几份保险、哪些是法律强制的、外国人能不能买、理赔实际是怎么走的，以及除了价格还该比较什么。',
  published: '2026-09-12T09:00:00+00:00',
  modified: '2026-09-12T09:00:00+00:00',
  breadcrumb: [...BREADCRUMB_ROOT, { name: '葡萄牙保险指南' }],
  pullquote: '保险不是在比谁便宜，而是在决定哪些风险自己扛、哪些交出去。',
  schemaType: 'Article',
...
<section class="section plain" aria-labelledby="lipei-zenme-zou">
  <div class="container narrow article-body">
    ...
    <ol class="process-steps">
      <li><strong>在时限内报案。</strong>保单会写明通知期限，从事故发生或发现之日起算，通常很短（常见为八天，以保单为准）。超过时限，保险公司可以据此减少或拒绝赔付。</li>
      <li><strong>保存证据。</strong>照片、损坏的物品、维修报价、发票、警方或消防记录。在查勘之前不要丢弃损坏物品，也不要急于全面修复——留下可查验的状态。</li>
      <li><strong>查勘定损（<em>peritagem</em>）。</strong>保险公司指派查勘人员评估原因与金额。这是整个流程中最关键的一步：原因认定决定这次损失属于哪一项保障，或者是否落入除外责任。</li>
      <li><strong>核定与赔付。</strong>按认定的金额扣除自负额后赔付，或由保险公司安排维修。涉及第三方时，还需要等待责任划分。</li>
      <li><strong>有争议时。</strong>可以要求书面说明拒赔或减赔的依据，可以自行委托独立查勘，也可以向保险公司的投诉部门、监管机构（ASF）或消费者调解机制提出。</li>
    </ol>
...
<section class="section tint" aria-labelledby="chu-le-jiage">
  <div class="container narrow article-body">
    <h2 id="chu-le-jiage">除了价格，还该比较什么</h2>
    <p>价格当然重要——没有人应该为一份保险多付钱。但价格只有在保障范围可比的前提下才有意义，而在葡萄牙市场上，两份保费相差三成的保单常常根本不是同一件东西。</p>
    <p>保险的本质是风险管理：把自己扛不动的损失，用一笔确定的、可以承受的支出转移出去。一份便宜三成、但把地震、水渍的查漏破拆费用、或出租用途排除在外的保单，并不是“更便宜的同样东西”，而是一件<strong>更小的东西</strong>。它可能恰好够用，也可能在最需要的那一天正好不够——区别在于这是一个知情的选择，还是一次没被发现的删减。</p>
    <p>所以比较时看这六项：</p>
    <ul>
    ...
    <p>把这六项列出来之后再看保费，判断通常就很清楚了。我们不以“最低保费”作为建议的依据，也不会用删掉真正需要的保障的方式把报价做低——那不是节省。</p>
  </div>
</section>
...
<section class="section plain" aria-labelledby="zhongjie-de-zuoyong">
  <div class="container narrow article-body">
    ...
    <p><strong>Adler &amp; Rochefort</strong> 是 Ownizo, Unipessoal Lda. 的商号，在 ASF 注册为保险代理人（<em>agente de seguros</em>），注册编号 <strong>425591790/3</strong>，办公地点在阿尔加维的拉各斯。我们在合作的保险公司范围内提供建议与安排，并协助客户处理理赔。</p>
    <p>为了避免误解，几点说明：</p>
    <ul>
