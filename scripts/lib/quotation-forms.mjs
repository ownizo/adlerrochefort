...
const PT_DIRECT_QUOTE_ROUTES = {
  ...
  '/blog/responsabilidade-civil-num-evento-portugal/': { target:'/seguros/responsabilidade-civil-eventos/#pedido', note:['As nossas propostas partem das coberturas que o risco exige. O prémio é o resultado dessa análise, nunca o ponto de partida.','Trabalhamos com um painel restrito de seguradoras internacionais, escolhidas pela solidez das condições contratuais e pela forma como respondem a um sinistro. Isso significa, com toda a franqueza, que raramente seremos a proposta mais barata que vai receber.','Se o seu critério de decisão for o prémio mais baixo, encontrará melhores valores noutro lado e preferimos dizê-lo já. Se for estar efetivamente protegido no dia em que precisar, é exatamente esse o trabalho que fazemos.'] },
