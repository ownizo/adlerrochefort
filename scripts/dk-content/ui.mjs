...
export const DK_UI = {
  ...
  mega: {
    ...
    spain: 'Forsikring i Spanien',
    spainMenu: 'Menu Spanien',
    privateClients: 'Private Clients',
    privateClientsMenu: 'Menu Private Clients',
    whyUs: 'Hvorfor os',
    whyUsMenu: 'Menu Hvorfor os',
    overview: 'Overblik',
    personal: 'Personforsikring',
    personalShort: 'Privat',
    moving: 'Flytning & bolig',
    property: 'Ejendom',
    hubItem: 'Forsikring i Portugal',
    spainHub: 'Forsikring for expats i Spanien',
    spainHealth: 'Sundhedsforsikring',
    spainHome: 'Husforsikring',
    spainCar: 'Bilforsikring',
    spainLife: 'Livsforsikring',
    spainLandlord: 'Udlejersforsikring',
    spainMortgage: 'Realkreditbeskyttelse',
    spainPC: 'Private Client-forsikring',
