...
<section class="section tint" aria-labelledby="apolice">
  <div class="container narrow article-body">
    ...
    <ol class="process-steps">
      <li><strong><em>Condições gerais</em> — de almindelige betingelser.</strong> Produktets trykte grundlag: definitioner, generelle undtagelser, pligter, skadesprocedure. Læses én gang og gælder hele aftaleperioden.</li>
      <li><strong><em>Condições especiais</em> — de særlige betingelser.</strong> Regler pr. dækning: hvad vandskadedækningen omfatter, hvordan tyveri defineres, hvilke undtagelser der gælder for ansvarsdelen.</li>
      <li><strong><em>Condições particulares</em> — dine oplysninger.</strong> Forsikringstager, genstand, forsikringssummer, selvrisici, valgte dækninger, præmie, periode. <strong>Det er det blad, der afgør din situation</strong>, og det eneste, der er unikt for dig.</li>
    </ol>
...
<section class="section tint" aria-labelledby="skadesag">
  <div class="container narrow article-body">
    ...
    <ol class="process-steps">
      <li><strong>Anmeld inden for betingelsernes frist.</strong> Fristerne er korte og angives pr. dækning — ofte få dage, undertiden otte. Ved tyveri eller hærværk kræves normalt politianmeldelse (<em>participação</em>), og den skal ske straks.</li>
      <li><strong>Begræns skaden.</strong> Luk for vandet, sikr det, der ellers ødelægges yderligere. Det er en pligt i betingelserne, ikke en høflighed.</li>
      <li><strong>Dokumentér.</strong> Billeder før noget udbedres, kvitteringer, tilbud, journaler. Dokumentation skaffet bagefter er svagere dokumentation.</li>
      <li><strong>Taksator (<em>peritagem</em>).</strong> Selskabet sender normalt en taksator. Rapporten styrer udfaldet, og den er altid på portugisisk. Her bistår vi.</li>
      <li><strong>Afgørelse og erstatning.</strong> Kontant erstatning eller reparation gennem selskabets netværk, afhængigt af produkt og valg.</li>
      <li><strong>Ved afvisning eller for lav erstatning:</strong> bed om afgørelsen skriftligt med henvisning til betingelsernes punkt, og bed om en fornyet vurdering. Mange sager vender i det led, med den rette dokumentation.</li>
    </ol>
...
<section class="section tint" aria-labelledby="syv">
  <div class="container narrow article-body">
    ...
    <ol class="process-steps">
      <li><strong>Er du registreret hos ASF, og under hvilket nummer?</strong> Registret er offentligt og søgbart.</li>
      <li><strong>Hvilke selskaber kan du placere hos?</strong> Ét enkelt selskab er ikke diskvalificerende, men det bør siges ligeud.</li>
      <li><strong>Får jeg betingelserne før tegningen, og på et sprog jeg forstår?</strong> Vi udleverer en skriftlig gennemgang på engelsk.</li>
      <li><strong>Hvordan er forsikringssummen beregnet?</strong> Kommer tallet fra købsprisen, er det sandsynligvis forkert.</li>
      <li><strong>Hvad er de tre vigtigste undtagelser i netop denne police?</strong> Kan de ikke nævnes, er betingelserne ikke læst.</li>
      <li><strong>Hvad sker der, når jeg anmelder en skade — hvem taler jeg med?</strong> Svaret afgør, hvad rådgivningen er værd.</li>
      <li><strong>Hvordan følger du policen over tid?</strong> En aftale, ingen ser på, bliver forkert af sig selv.</li>
    </ol>
  </div>
</section>
