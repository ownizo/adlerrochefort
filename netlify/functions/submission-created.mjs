...
export const HANDLED_FORMS = {
  ...
  "de-free-analysis": {
    quote: true,
    lang: "de",
    heading: "New German free-analysis request — homepage",
    page: "/de/",
  },
  "de-contact": {
    lang: "de",
    heading: "New German contact message — homepage",
    page: "/de/",
  },
  "de-versicherung-spanien": {
    quote: true,
    lang: "de",
    heading: "New German expat insurance review — Spain",
    page: "/de/versicherung-spanien/",
    branch: "ES · Expat (DE)",
  },
  "de-krankenversicherung-spanien": {
    quote: true,
    lang: "de",
    heading: "New German health quote — Spain",
    page: "/de/krankenversicherung-spanien/",
    branch: "ES · Health (DE)",
  },
  "de-hausversicherung-spanien": {
    quote: true,
    lang: "de",
    heading: "New German home quote — Spain",
    page: "/de/hausversicherung-spanien/",
    branch: "ES · Home (DE)",
  },
  "de-autoversicherung-spanien": {
    quote: true,
    lang: "de",
    heading: "New German car quote — Spain",
    page: "/de/autoversicherung-spanien/",
    branch: "ES · Car (DE)",
  },
  "de-lebensversicherung-spanien": {
    quote: true,
    lang: "de",
    heading: "New German life quote — Spain",
    page: "/de/lebensversicherung-spanien/",
    branch: "ES · Life (DE)",
  },
  "de-vermieterversicherung-spanien": {
    quote: true,
    lang: "de",
    heading: "New German landlord quote — Spain",
    page: "/de/vermieterversicherung-spanien/",
    branch: "ES · Landlord (DE)",
  },
  "de-hypothekenschutz-spanien": {
    quote: true,
    lang: "de",
    heading: "New German mortgage-protection quote — Spain",
    page: "/de/hypothekenschutz-spanien/",
    branch: "ES · Mortgage (DE)",
  },
  "de-private-clients-spanien": {
    quote: true,
    lang: "de",
    heading: "New German private-client review — Spain",
    page: "/de/private-clients-spanien/",
    branch: "ES · Private Clients (DE)",
  },
  "valuables-review": {
